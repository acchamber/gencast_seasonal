...
try:
    jax.tree_util.register_pytree_node(
        ...
        print("duplicate registration detected, skipping registration for xarray.Variable")
...
try:
    ...
    print("duplicate registration detected, skipping registration for xarray.IndexVariable")
try: 
    jax.tree_util.register_pytree_node(
        xarray.DataArray, _flatten_data_array, _unflatten_data_array)
except ValueError:
    print("duplicate registration detected, skipping registration for xarray.DataArray")
try:
    jax.tree_util.register_pytree_node(
        xarray.Dataset, _flatten_dataset, _unflatten_dataset)
except ValueError:
    print("duplicate registration detected, skipping registration for xarray.Dataset")
